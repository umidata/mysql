  ...
  case LOG_READ_BINLOG_LAST_VALID_POS:
        {
          ...
          */
          ...
          /*
            ...
            As of MySQL 5.7.20 and 5.7.5, mysqlbinlog redundantly sets
...
/*
  ...
  ("same" means with the same UUID(for slave versions >= 5.7) or same server id
  (for slave versions < 5.7). Indeed, if the slave stops, if the
