...
private:
  /**
     ...
     This is true and enforced starting with MySQL 5.7.10.
     In practice, in previous versions such as MySQL 5.5 (GA) or earlier 5.7
     ...
     - performing replication from a 5.5 master to a 5.7 slave during
       upgrades
     - performing replication from 5.5 (performance_schema enabled)
       to a 5.7 slave
     - performing point in time recovery in 5.7 with old archived logs.
