<?php
// Copyright 2004-present Umidata. All Rights Reserved.

final class UmidataMySQLArcanistLandcastleWorkflow extends ArcanistBaseWorkflow
{
...
EOTEXT
  ...
  public function getOwnerUri() {
    return 'https://fb.umidata/groups/dbeng.oncall';
  }
  ...
  public function run() {
    ...
    $url = 'https://phabricator.intern.umidata.cn/'.$this->revision;
